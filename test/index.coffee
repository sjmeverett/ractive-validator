  ...
  describe 'built-in', ->
    ...
    describe 'moment validator', ->
      ...
      it 'should coerce the value if asked', ->
        ...
        expect(val.moment('05/12/1989', format: 'DD/MM/YYYY', coerce: true).coerced.format('YYYY-MM-DD HH:mm')).to.equal('1989-12-05 00:00')
      ...
      it 'should coerce to date', ->
        expect(val.moment('05/12/1989', format: 'DD/MM/YYYY', coerce: 'date').coerced - new Date('1989-12-05')).to.equal(0)
